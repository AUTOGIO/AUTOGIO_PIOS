...
- **PIOS Awake** — `~/Applications/PIOS Awake.app`  
  ...
  Source: `~/AUTOGIO_PIOS/tools/pios_awake/`
- Daily health Reminders (10:00 / 22:00, list **PIOS Network**)
- Scripts under `networking/unifi_baseline/scripts/` (health, WAN watch, WAN status, page opener)
...
| Item | Path |
|------|------|
| Baseline README | `~/AUTOGIO_PIOS/networking/unifi_baseline/README.md` |
| This report | `~/AUTOGIO_PIOS/networking/unifi_baseline/reports/executive_report_20260713.md` |
| WAN watch log | `~/AUTOGIO_PIOS/networking/unifi_baseline/reports/wan_watch_stdout.log` |
| WAN API sample | `~/AUTOGIO_PIOS/networking/unifi_baseline/reports/wan_status_20260713-005945.txt` |
| Local admin env | `~/AUTOGIO_PIOS/networking/unifi_baseline/.unifi.local.env` |
| Wi‑Fi env | `~/AUTOGIO_PIOS/networking/unifi_baseline/.pios_wifi.env` |
| PIOS Awake | `~/Applications/PIOS Awake.app` |
